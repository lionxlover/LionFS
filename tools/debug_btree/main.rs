...
fn main() {
    let test_file = "test_prop_insert_lookup.img";
    ...
    let keys = vec![
        1516, 185, 928, 937, 408, 1851, 976, 1365, 1036, 1171, 248, 1973, 723, 1639, 1502, 772, 70, 1328, 1645, 726, 1005, 1453, 1095, 1518, 170, 912, 1784, 1533, 576, 1534, 1947, 1982, 1884, 1783, 194
    ];
    ...
    for (idx, &k) in keys.iter().enumerate() {
        ...
        let inode = Inode {
            ...
            checksum: 0, spill_pad_head: [0; 4], spill_extent_root: 0,
        };
