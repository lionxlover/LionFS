...
- The 2.0 structures (B-epsilon, HAMT, inode v3, io_uring engine) are
  implemented and tested **beside** the live 1.x paths; the roadmap's
  remaining work is switching the write path onto them, phase by
  phase, under the interleaved A/B measurement protocol.
